...
#ifndef PETEletrica_h
#define PETEletrica_h
...
class Motores {
public:
	Motores(int IN1, int IN2, int IN3, int IN4);
	int _IN1;
	int _IN2;
	int _IN3;
	int _IN4;

	void set_motors(int vel_esq, int vel_dir);
};

//==================================== PARA O LINUS FIXO - PONTE H L293D ====================================
class MotoresFixo {
public:
	MotoresFixo(int ENE, int END,int IN1, int IN2, int IN3, int IN4);
	int _IN1;
	int _IN2;
	int _IN3;
	int _IN4;
	int _END;
	int _ENE;
	void set_motorsFixo(int vel_esq, int vel_dir);
};
...
{
public:
	SensorUltrassonico(int tp, int ep);
	long timing();
...
class SensorInfravermelhoRC : public SensorInfravermelho
{
	// allows the base QTRSensors class to access this class' 
	// readPrivate()
	friend class SensorInfravermelho;
	
public:

	// if this constructor is used, the user must call init() before using
	// the methods in this class
	SensorInfravermelhoRC() { }
	
	// this constructor just calls init()
	SensorInfravermelhoRC(unsigned char* pins, unsigned char numSensors, 
...
class SensorInfravermelhoAnalog : public SensorInfravermelho
{
	// allows the base QTRSensors class to access this class
	// readPrivate()
	friend class SensorInfravermelho;
...
public:
	...
	// if this constructor is used, the user must call init() before using
	// the methods in this class
	SensorInfravermelhoAnalog() { }
	
	// this constructor just calls init()
	SensorInfravermelhoAnalog(unsigned char* pins, 
